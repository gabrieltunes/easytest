    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-danger" action="{{action('Questao_ObjetivaController@destroy', $questao['id'])}}" onclick="event.preventDefault();document.getElementById('exclusao-form').submit();">{{ __('Excluir') }}</a>

            <form id="exclusao-form" action="{{action('Questao_ObjetivaController@destroy', $questao['id'])}}" method="POST">
            @csrf

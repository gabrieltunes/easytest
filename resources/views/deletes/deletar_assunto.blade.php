    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-danger" action="{{action('AssuntoController@destroy', $assunto['id'])}}" onclick="event.preventDefault();document.getElementById('exclusao-form').submit();">{{ __('Excluir') }}</a>

            <form id="exclusao-form" action="{{action('AssuntoController@destroy', $assunto['id'])}}" method="POST">
            @csrf

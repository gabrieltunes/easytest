    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-danger" action="{{action('Cabecalho_ProvaController@destroy', $cabecalho['id'])}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">{{ __('Excluir') }}</a>

            <form id="logout-form" action="{{action('Cabecalho_ProvaController@destroy', $cabecalho['id'])}}" method="POST">
            @csrf
